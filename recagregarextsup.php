...
$sql="INSERT INTO
extsup (id, nombre, tipos, descripcion) 
...
require_once('lib.php');
?>
<form action="recagregarextsup.php" method="post" align="center">
	<table collapse align="center">
	<tr>Extremidades Superiores</tr>
	<tr>
...
echo "</tr>";
foreach ($extsup as $key => $value) {
	echo "<tr>";
	echo "<form action='eliminarextsup.php' method='POST'>";
