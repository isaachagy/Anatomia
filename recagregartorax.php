...
$sql="INSERT INTO
torax (id, nombre, tipos, descripcion) 
...
require_once('lib.php');
?>
<form action="recagregartorax.php" method="post" align="center">
	<table collapse align="center">
	<tr>Torax</tr>
	<tr>
...
echo "</tr>";
foreach ($torax as $key => $value) {
	echo "<tr>";
	echo "<form action='eliminartorax.php' method='POST'>";
