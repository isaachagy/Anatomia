...
$sql="INSERT INTO
dorso (id, nombre, tipos, descripcion) 
...
require_once('lib.php');
?>
<form action="recagregardorso.php" method="post" align="center">
	<table collapse align="center">
	<tr>Dorso</tr>
	<tr>
...
echo "</tr>";
foreach ($dorso as $key => $value) {
	echo "<tr>";
	echo "<form action='eliminardorso.php' method='POST'>";
