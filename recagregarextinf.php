...
$sql="INSERT INTO
extinf (id, nombre, tipos, descripcion) 
...
require_once('lib.php');
?>
<form action="recagregarextinf.php" method="post" align="center">
	<table collapse align="center">
	<tr>Extremidades Inferiores</tr>
	<tr>
...
echo "</tr>";
foreach ($extinf as $key => $value) {
	echo "<tr>";
	echo "<form action='eliminarextinf.php' method='POST'>";
